...
const sample: Profile = { public_id: "sample-tommy", pet_name: "Tommy", breed: "Golden Retriever", public_message: "I love treats and gentle pats. Please help me get home.", is_friendly: true, is_ready: true, owner_phone: "+91 98765 43210", owner_address: "42 Lake View Road, Pune", share_address: true };
